...
void BombermanPlayer::Move(){
	if(Alive == 0) return;
	if(Direction == Right){
		if(this->X+1 < _game->MaxX &&( _game->Grid[this->X+1][this->Y] == _game->Walkable || _game->Grid[this->X+1][this->Y] == _game->Explotion)){
		...
		if(this->Y-1 >= 0 &&( _game->Grid[this->X][this->Y-1] == _game->Walkable || _game->Grid[this->X][this->Y-1] == _game->Explotion  )){
			if(_game->Grid[this->X][this->Y] != _game->Bomb)
				_game->Grid[this->X][this->Y] = _game->Walkable;
		...
		if(this->X-1 >= 0 && (_game->Grid[this->X-1][this->Y] == _game->Walkable ||_game->Grid[this->X-1][this->Y] == _game->Explotion) ){
			if(_game->Grid[this->X][this->Y] != _game->Bomb)
			_game->Grid[this->X][this->Y] = _game->Walkable;		
		...
		if(this->Y+1 < _game->MaxY && (_game->Grid[this->X][this->Y+1] == _game->Walkable || _game->Grid[this->X][this->Y+1] == _game->Explotion)){
			if(_game->Grid[this->X][this->Y] != _game->Bomb)
			_game->Grid[this->X][this->Y] = _game->Walkable;		
